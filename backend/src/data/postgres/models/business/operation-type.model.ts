...
export class OperationTypeModel {
    private static readonly TABLE_NAME = 'operation_types';

    static async create(data: CreateOperationTypeDto): Promise<OperationType> {
    ...
    static async findById(id: string): Promise<OperationType | null> {
        const client = PostgresDatabase.getClient();
    ...
    static async findByTitle(title: string): Promise<OperationType | null> {
        const client = PostgresDatabase.getClient();
    ...
    static async update(id: string, updateData: Partial<CreateOperationTypeDto>): Promise<OperationType | null> {
        const client = PostgresDatabase.getClient();
        if (!updateData.title) {
