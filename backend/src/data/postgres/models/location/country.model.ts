...
export class CountryModel {
    private static readonly TABLE_NAME = 'countries';

    static async create(data: CreateCountryDto): Promise<Country> {
    ...
    static async findByTitle(title: string): Promise<Country | null> {
        const client = PostgresDatabase.getClient();
    ...
    static async update(id: string, updateData: Partial<CreateCountryDto>): Promise<Country | null> {
        const client = PostgresDatabase.getClient();
