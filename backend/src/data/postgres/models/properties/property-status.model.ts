...
export class PropertyStatusModel {
    private static readonly TABLE_NAME = 'property_status';
    ...
    static async findById(id: string): Promise<PropertyStatus | null> {
        const client = PostgresDatabase.getClient();
    ...
    static async findByTitle(title: string): Promise<PropertyStatus | null> {
        const client = PostgresDatabase.getClient();
    ...
    static async update(id: string, updateData: Partial<CreatePropertyStatusDto>): Promise<PropertyStatus | null> {
        const client = PostgresDatabase.getClient();
        if (!updateData.title) {
