import { PropertyModel } from "../../data/postgres/models";
import { TransactionHelper } from "../../data/postgres/transaction.helper";
import { ClientEntity, CustomError } from "../../domain";
import type { CreateOwnerDto } from "../../domain/dtos/clients/create-owner.dto";
			...
			if (
				...
				if (!updatedProperty) {
					throw CustomError.internalServerError(
						"Failed to associate owner with property",
					);
				}
			}
