...
import type { LeadServices } from "../services/lead.services";
import type { OwnerServices } from "../services/owner.services";
import type { TenantServices } from "../services/tenant.services";
...
export class ClientController {
	...
	createOwner = async (req: Request, res: Response) => {
		try {
			...
			const result =
				await this.ownerServices.createOwnerWithProperty(createOwnerDto);
